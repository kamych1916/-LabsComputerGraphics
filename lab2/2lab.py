...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.imageLabel.setPixmap(self.pixmap)
        self.imageLabel.move(130, 100)
        self.resize(220+self.pixmap.width()+50, 50+self.pixmap.height()+50)
        self.center()

        self.qbtn = QPushButton('Применить линейное контрастирование', self)
        self.qbtn.clicked.connect(self.on_click)
        self.qbtn.resize(self.qbtn.sizeHint())
        self.qbtn.move(170, 60)
        self.qbtn1 = QPushButton('Применить нормализацию', self)
        self.qbtn1.clicked.connect(self.on_click1)
        self.qbtn1.resize(self.qbtn1.sizeHint())
        self.qbtn1.move(70, 20)
        self.qbtn1 = QPushButton('Применить эквализацию', self)
        self.qbtn1.clicked.connect(self.on_click2)
        self.qbtn1.resize(self.qbtn1.sizeHint())
        self.qbtn1.move(340, 20)

        self.setWindowTitle('Улучшение изображения путем изменения контраста')
        self.show()
